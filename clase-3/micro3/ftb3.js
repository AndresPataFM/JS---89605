...
const COMISION = 1.025; //comisión del 2.5%
const metrosCuadradosIngresados = Number(prompt("Ingresa los Metros cuadrados de la propiedad a cotizar un seguro:"));

const calcularPoliza = metrosCuadrados => metrosCuadrados * VALOR_M2 * COMISION;

const valorPoliza = calcularPoliza(metrosCuadradosIngresados);
console.log("El costo de la póliza es: $", valorPoliza);