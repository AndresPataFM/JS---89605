...
const IVA_ARGENTINA = 1.21;

/* const calcularIVA = (productoValor)=>{
  const calcular = productoValor*IVA_ARGENTINA
  return calcular
} */

const calcularIVA = productoValor => productoValor*IVA_ARGENTINA
